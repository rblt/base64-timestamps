...
describe('Encoding timestamps',() => {
    it('timestamps1 should be encoded correctly',() => {
        expect(tools.convert.encodeTimeStamps(originalTimeStamps1)).toEqual(encodedTimeStamps1);
    })

    it('timestamps2 should be encoded correctly',() => {
        expect(tools.convert.encodeTimeStamps(originalTimeStamps2)).toEqual(encodedTimeStamps2);
    })

    it('timestamps3 should be encoded correctly',() => {
        expect(tools.convert.encodeTimeStamps(originalTimeStamps3)).toEqual(encodedTimeStamps3);
    })
});
